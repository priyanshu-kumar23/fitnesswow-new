  ...
  {services.map((service, index) => {
    ...
    return (
      <motion.div
        ...
        viewport={{ once: true }}
        className="group relative overflow-hidden rounded-[1.8rem] border border-white/10 bg-gradient-to-b from-white/[0.07] to-white/[0.03] p-5 backdrop-blur-2xl transition-all duration-500 hover:-translate-y-2 hover:border-yellow-400/30 hover:shadow-[0_0_45px_rgba(250,204,21,0.08)] sm:rounded-[2rem] sm:p-7"
      >
